...
@XmlRootElement(name = "ModifierParcours", namespace = "http://Geonote/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ModifierParcours", namespace = "http://Geonote/", propOrder = {
    "id",
    "numero",
    "titre",
    "description",
